import { setMultipleAttributes } from "./entry-display-helpers/dom-creation.js"
import {
  populatePlaceholder,
  clearPlaceholder,
  validationWarning,
...
export default function journalEntryForm({ addEntry } = {}) {
  ...
  formElements.buttons.create.addEventListener("click", (e) => {
    ...
    setMultipleAttributes(formElements.form, {
      role: "region",
      tabindex: "-1",
    ...
    setTimeout(() => {
      ...
      formElements.form.removeAttribute("role")
      formElements.form.removeAttribute("tabindex")
      formElements.form.removeAttribute("aria-label")
    }, 2000)
